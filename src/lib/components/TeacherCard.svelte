...
<div class="relative">
  {#if canAccessProfile}
    <a
      ...
      class="block bg-white rounded-card shadow-card border border-gray-100 p-6 group hover:shadow-card-hover transition-all"
    >
  ...
  {:else}
    <div class="block bg-white rounded-card shadow-card border border-gray-100 p-6 group opacity-50 cursor-not-allowed">
      <div class="flex gap-4">
    <!-- Avatar -->
    <div class="flex-shrink-0">
      {#if teacher.avatar_url}
