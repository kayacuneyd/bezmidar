...
<div class="container mx-auto px-4 py-12 max-w-4xl">
  ...
  <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
    ...
    <section class="mb-8">
      <h2 class="text-xl font-bold mb-4">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
      <p class="text-gray-700 leading-relaxed">
        Max Mustermann<br>
        Musterstraße 123<br>
        10115 Berlin
    ...
    <section class="mb-8">
      <h2 class="text-xl font-bold mb-4">Haftungsausschluss (Disclaimer)</h2>
      
      <h3 class="font-bold mt-4 mb-2">Haftung für Inhalte</h3>
      <p class="text-gray-700 text-sm mb-4">
        Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis 10 TMG sind wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde Informationen zu überwachen oder nach Umständen zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen.
      </p>

      <h3 class="font-bold mt-4 mb-2">Haftung für Links</h3>
